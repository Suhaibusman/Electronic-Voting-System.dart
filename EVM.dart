...
addPA() {
  ...
  poolingAgent.add({
    'username': poolingIdInput,
    'password': poolingPassInput,
    'party': newPartyValue
  });
  print(
      "Username: $poolingIdInput and Password: $poolingPassInput added successfully");
  print("==================================================");
}
...
updatePA() {
  ...
  print(
      "Username: $newUserNameValue and Password: $newPasswordValue Updated Successfully on the index number : $inputPool and Party is $newPartyValue");
  print("==================================================");
}
